...
class AlBertFusionAttCRFTokenClassModel(nn.Module):

    def __init__(self, albert_path,
                 start_label_id=28, stop_label_id=29, num_labels=31):
        super(AlBertFusionAttCRFTokenClassModel, self).__init__()
...
if __name__ == '__main__':
    ...
    model = AlBertFusionAttCRFTokenClassModel(bert_path_).cuda()
